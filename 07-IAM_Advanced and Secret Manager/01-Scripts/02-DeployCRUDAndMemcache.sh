...
('EC2', 'Web service that provides sizable compute capacity in the cloud.', 's3://crud-s3-directory-2026-02-19/ec2logo.png', 'arn:aws:s3:::BUCKET_NAME_PLACEHOLDER/image1.png', 'sample-etag-1', 1),
('Memcache', 'Is a free, open-source, high-performance, distributed memory object caching system.', 's3://crud-s3-directory-2026-02-19/memcachelogo.png', 'arn:aws:s3:::BUCKET_NAME_PLACEHOLDER/image2.png', 'sample-etag-2', 1),
('Route53', 'is a highly available and scalable cloud Domain Name System (DNS) web service designed to route end-users to internet applications by translating human-readable names.', 's3://crud-s3-directory-2026-02-19/route53logo.png', 'arn:aws:s3:::BUCKET_NAME_PLACEHOLDER/image3.png', 'sample-etag-3', 1),
('RDS', 'Is a managed relational database service for MySQL, PostgreSQL, MariaDB, Oracle, or SQL Server.', 's3://crud-s3-directory-2026-02-19/rdslogo.png', 'arn:aws:s3:::BUCKET_NAME_PLACEHOLDER/image4.png', 'sample-etag-4', 1);
SQL
USERDATA
