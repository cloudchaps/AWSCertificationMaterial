...
DB_SECURITYGROUP="${2:-crud-db-security-group}"
DB_NAME="${2:-cruddb}"
DB_USER="${3:-admin}"
...
apt-get update -y
apt-get install -y php libapache2-mod-php php-mysql apache2 mysql-client

# Download index.php from GitHub
cd /var/www/html
curl -o index.php https://raw.githubusercontent.com/cloudchaps/AWSCertificationMaterial/refs/heads/main/05-RDS%20%2B%20Aurora%20%2B%20ElasticCache/06-CRUDService/index.php
